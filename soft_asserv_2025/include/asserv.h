...
void init_asserv (struct _goldo_asserv *_ga, uint32_t _mot_reg, uint32_t _enc_reg, uint32_t _cmd_reg, uint32_t _sta_reg, uint32_t _pos_reg, uint32_t _dbg_reg, uint32_t _sw_reg, uint32_t _sw_mask, int _home_dir, int _polar);
